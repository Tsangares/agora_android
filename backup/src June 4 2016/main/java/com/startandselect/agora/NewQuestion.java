...
public class NewQuestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputQuestion  = (EditText) findViewById(R.id.newquestion_questioninput);
        inputTags      = (EditText) findViewById(R.id.newquestion_taginput);
        submit         = (Button)   findViewById(R.id.newquestion_submit);
        prompt         = (TextView) findViewById(R.id.newquestion_prompt);
