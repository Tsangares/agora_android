...
public class main extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toolbar toolbar = (Toolbar) findViewById(R.user_id.toolbar);
        ...
        agora_tab = Agora_tab.newInstance();
    ...
    public void setFilterMode(int filterMode){
        agora_tab.setFilterMode(filterMode);
    }
    public void setFilterTags(String filterTags){
        agora_tab.setFilterTags(filterTags);
    }
    public void setSearchQuery(String searchQuery){
        agora_tab.setSearchQuery(searchQuery);
    }
    public String getFilterTags(){
        return agora_tab.getFilterTags();
    }
    public Integer getFilterMode(){
        return agora_tab.getFilterMode();
    }
    public String getSearchQuery(){
        return agora_tab.getSearchQuery();
    }
    public void     updateQuestions(JSONObject data){
        agora_tab.updateQuestions(data);
    }
